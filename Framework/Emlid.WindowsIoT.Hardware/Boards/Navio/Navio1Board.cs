...
namespace Emlid.WindowsIot.Hardware.Boards.Navio
{
    ...
    /// </remarks>
    public sealed class Navio1Board : DisposableObject, INavioBoard
    {
        #region Lifetime
        ...
        /// </param>
        public Navio1Board(float pwmFrequency = PwmCycle.ServoSafeFrequency)
        {
            // Initialize components
            Ms5611 = new NavioBarometerDevice();
            Mb85rc04v = new NavioFramDevice(NavioHardwareModel.Navio1);
        ...
        /// Hardware model.
        /// </summary>
        public NavioHardwareModel Model { get { return NavioHardwareModel.Navio1; } }
        ...
        /// </summary>
        public INavioFramDevice Fram { get { return Mb85rc04v; } }
        ...
        /// </summary>
        public NavioFramDevice Mb85rc04v { get; private set; }
